...
class CFrameProcessThreadDlg : public CDialogEx
{
// 构造
public:
	CFrameProcessThreadDlg(CWnd* pParent = nullptr);	// 标准构造函数

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_FRAMEProcessThread_DIALOG };
#endif
...
public:
	...
	CListProcessThreadData* m_pListData = NULL;
