...
class CFrameRegOperationDlg : public CDialogEx
{
// 构造
public:
	CFrameRegOperationDlg(CWnd* pParent = nullptr);	// 标准构造函数

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_FrameRegOperation_DIALOG };
#endif
...
public:
	...
	CListRegOperationData* m_pListData = NULL;
